...
CREATE TABLE IF NOT EXISTS request (
    ...
    CONSTRAINT pk_request_user_id FOREIGN KEY (user_id) REFERENCES users (id)
);
...
CREATE TABLE IF NOT EXISTS item (
  ...
  CONSTRAINT pk_item_user_id FOREIGN KEY (owner_id) REFERENCES users (id),
  CONSTRAINT pk_item_request_id FOREIGN KEY (request_id) REFERENCES request (id)
);
