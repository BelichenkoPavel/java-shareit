...
public class ItemService {
    ...
    public Item addItem(CreateItemDto itemDto, Long userId) {
        ...
        if (itemDto.getRequestId() != null) {
            ItemRequestDto itemRequest = itemRequestService.getById(itemDto.getRequestId());
            itemModel = itemRepository.save(ItemModelMapper.mapCreateItem(itemDto, user, itemRequest));
        } else {
            itemModel = itemRepository.save(ItemModelMapper.mapCreateItem(itemDto, user));
        }
    ...
    public List<Item> getByRequestId(Long requestId) {
        return ItemMapper.mapModelsList(itemRepository.findByRequestId(requestId));
    }
}
